...
require([
    ...
    function refreshBookmarks() {
        if ( useLocalStorage ) {
            ...
            var appBMs = [];
            array.forEach(sbra.bookmarks, function (bm){
                if (bm.userCreated === false){
                    appBMs.push(bm.id);
                }
            });
            var bmStorageArray = sbra.bookmarks.slice();
            ...
            cookie(storageName, dojo.toJson(sbra.bookmarks), {
                expires: exp
            });
        }
    }
    ...
    function removeUserBookmarks () {
        ...
        //removes user bookmarks from the sbra.bookmarks array
        for(var i = 0; i < sbra.bookmarks.length; i++) {
            var obj = sbra.bookmarks[i];

            if(userBMs.indexOf(obj.id) !== -1) {
                sbra.bookmarks.splice(i, 1);
                i--;
                //!!!IMPORTANT:If adding another permanent bookmark (non-user defined) may need another i decrement.
            }
        }
    ...
    function saveUserBookmark () {
        ...
        if (userBookmarkTitle.length > 0 ){
            ...
            sbra.bookmarks.push(currentMapExtentJSON);
    ...
    $(document).ready(function(){
        ...
        sbra.bookmarks.forEach(function(bm) {
            if (bm.userCreated === false) {
        ...
        $("body").on('click', '.td-bm' ,function (){
            ...
            sbra.bookmarks.forEach(function(bookmark) {
    ...
    require([
        ...
        const normRestorationIndexLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "normalized", visible:true} );
        ...
        const dikesLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_hydroCondition/MapServer", {id: "dikes", visible:false, minScale:100000} );
        ...
        const degFlowlinesLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_hydroCondition/MapServer", {id: "degFlowlines", visible:false, minScale:100000} );
        ...
        const culvertsLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_hydroCondition/MapServer", {id: "culverts", visible:false, minScale:100000} );
        ...
        const studyAreaLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_reference/MapServer", {id: "studyArea", visible:true} );
        ...
        const GLRIWetlandsLayer = new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_reference/MapServer", {id: "GLRIWetlands", visible:true, minScale: 100000, maxScale: 10000 } );
        ...
        var aerialsLayer = new FeatureLayer(mapServiceRoot + "SBRA_reference/MapServer/1", {id: "aerials", layerID: "aerials", visible:false, minScale:100000, mode: FeatureLayer.MODE_ONDEMAND, outFields: ["*"], infoTemplate: aerialsPopup});
        ...
        ///parameters group
        const landuseLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "landuse", visible:false} );
        ...
        const imperviousSurfacesLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "imperviousSurfaces", visible:false} );
        ...
        const conservedLandsLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "conservedLands", visible:false} );
        ...
        const flowlineLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "flowline", visible:false} );
        ...
        const wetsoilsLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "wetsoils", visible:false} );
        ...
        const hydroperiodLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "hydroperiod", visible:false} );
        ...
        const waterMaskLayer =  new ArcGISDynamicMapServiceLayer(mapServiceRoot + "SBRA_restorationModel/MapServer", {id: "waterMask", visible:true, opacity: 0.75} );
